...
class AlphabeticalScrollView extends StatefulWidget {
  ...
  @override
  State<AlphabeticalScrollView> createState() => _AlphabeticalScrollView();
}

class _AlphabeticalScrollView extends State<AlphabeticalScrollView> {
  void init() {
    widget.list
  ...
  final positionNotifier = ValueNotifier<Offset>(const Offset(0, 0));
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: GestureDetector(
                ...
                onVerticalDragEnd: (z) => setState(() => isFocused = false),
