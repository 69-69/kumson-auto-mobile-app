...
class AvatarGlow extends StatefulWidget {
  ...
  final Curve curve;
  final bool showTwoGlows, wrapChild;
...
class _AvatarGlowState extends State<AvatarGlow>
  ...
  Widget build(BuildContext context) {
    return  AnimatedBuilder(
      ...
      child: widget.wrapChild ? wrapper(widget.child) : widget.child,
      builder: (_, widgetChild) {
        ...
        return buildSizedBox(decoration, widgetChild);
      },
    );
  }

  wrapper(Widget? child, {Color? color}) => Material(
    elevation: 0.0,
  ...
  SizedBox buildSizedBox(BoxDecoration decoration, Widget? widgetChild) {
    return SizedBox(
